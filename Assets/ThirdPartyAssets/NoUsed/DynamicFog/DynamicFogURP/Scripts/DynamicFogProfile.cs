...
namespace DynamicFogAndMist2 {
    ...
    public class DynamicFogProfile : ScriptableObject {
        ...
        [Tooltip("If enabled, base altitude acts as a hard clipping plane preventing fog from rendering below it.")]
        public bool baseAltitudeClip;
        ...
        [FormerlySerializedAs("densityLinear")]
        public float density = 0.55f;
        public float startDistance;
        [FormerlySerializedAs("densityExponential")]
        public float heightSpread = 0.94f;
        ...
        [Tooltip("Hides fog behind opaque objects")]
        ...
        public void ValidateSettings() {
            ...
            heightSpread = Mathf.Max(0, heightSpread);
            startDistance = Mathf.Max(0, startDistance);
        ...
        public void Lerp(DynamicFogProfile p1, DynamicFogProfile p2, float t) {
            ...
            heightSpread = p1.heightSpread * t0 + p2.heightSpread * t;
            startDistance = p1.startDistance * t0 + p2.startDistance * t;
            ...
            depthClip = t < 0.5f ? p1.depthClip : p2.depthClip;
            baseAltitudeClip = t < 0.5f ? p1.baseAltitudeClip : p2.baseAltitudeClip;
            useXYZDistance = t < 0.5f ? p1.useXYZDistance : p2.useXYZDistance;
            useVerticalGradient = t < 0.5f ? p1.useVerticalGradient : p2.useVerticalGradient;
            useSunColor = t < 0.5f ? p1.useSunColor : p2.useSunColor;
            noiseColorBlend = p1.noiseColorBlend * t0 + p2.noiseColorBlend * t;
            noiseColor = p1.noiseColor * t0 + p2.noiseColor * t;
            noiseDistanceAtten = p1.noiseDistanceAtten * t0 + p2.noiseDistanceAtten * t;
