...
namespace DynamicFogAndMist2 {
    ...
    public partial class DynamicFog : MonoBehaviour {
        ...
        static class ShaderParams {
            ...
            public static int StartDistance = Shader.PropertyToID("_StartDistance");
            ...
            public const string SKW_BASE_ALTITUDE_CLIP = "DF2_BASE_ALTITUDE_CLIP";
        }
        ...
        void OnDrawGizmos () {
            if (enableFogOfWar && fogOfWarShowBoundaries) {
                Gizmos.color = new Color(1, 1, 0, 1f);
                Gizmos.DrawCube(fogOfWarCenter, fogOfWarSize);
            }
        }        
        ...
        void ApplyProfileSettings () {
            ...
            fogMat.SetVector(ShaderParams.Density, new Vector3(1.001f - activeProfile.heightSpread, activeProfile.density));
            fogMat.SetFloat(ShaderParams.StartDistance, activeProfile.startDistance);
            ...
            if (activeProfile.baseAltitudeClip) {
                fogMat.EnableKeyword(ShaderParams.SKW_BASE_ALTITUDE_CLIP);
            }
            else {
                fogMat.DisableKeyword(ShaderParams.SKW_BASE_ALTITUDE_CLIP);
            }
